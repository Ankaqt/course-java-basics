...
public class Task07 {
    public static void main(String[] args) {
        ...
        double startDistance1 = startDistance;
        double totalDistance = 0;
        if (startDistance1 != 0 ) {
            while (startDistance1 < finishDistance) {
                totalDistance += startDistance1;
                startDistance1 = startDistance1 + (startDistance1 * dailyProgress / 100);
            }
